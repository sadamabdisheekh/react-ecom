            ...
            <ul className="flex space-x-8 text-gray-700">
                ...
                <div className="relative">
                    <Link to="/cart" className="hover:text-pink-700">
                        ...
                        <span className="absolute -top-1 -right-1 bg-pink-600 text-white rounded-full text-xs w-5 h-5 flex items-center justify-center">{context.products.length}</span>
                    </Link>
                </div>
            </ul>
        </div>
